...
TEST(Game2048, ColorCodes) {
  EXPECT_EQ(Game2048::getElemColor(2), ::cxxg::types::Color::BLUE);
  EXPECT_EQ(Game2048::getElemColor(32), ::cxxg::types::Color::BLUE);
  EXPECT_EQ(Game2048::getElemColor(64), ::cxxg::types::Color::GREEN);
  EXPECT_EQ(Game2048::getElemColor(8), ::cxxg::types::Color::YELLOW);
  EXPECT_EQ(Game2048::getElemColor(16), ::cxxg::types::Color::RED);
}
